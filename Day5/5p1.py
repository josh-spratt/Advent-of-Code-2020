...
#boarding_pass_file = 'boarding_passes.txt'
#with open(boarding_pass_file) as f:
    #lines = f.read()

"""seats_range = list(range(0, 128))
half = len(seats_range)//2
boarding_pass = 'FBFBBFF'
if boarding_pass[0] == 'F':
    row_range_1 = seats_range[:half]
    half_row_range_1 = len(row_range_1)//2
if boarding_pass[0] == 'B':
    row_range_1 = seats_range[half:]
    half_row_range_1 = len(row_range_1)//2
